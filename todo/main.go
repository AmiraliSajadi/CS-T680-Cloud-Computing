...
//						   on how to use it.
//
//	 YOUR ANSWER: The flag package, enables us to handle command-line flags in
//	 Go programs by defining flags, parsing them, and accessing their values.
//	 Each flag takes in 4 arguments: (1) the variable in which the value of the
// 	 flag will be stored, (2) name of the CLI argument, (3) default value for
//   the flag, and (4) the description. After parsing the flag we can check the
//   manually set values in the CLI and use them in the Go program.
